...
$(function() {
  // 测试设置cookie
  /*var userObj = {id: 4,openid: 123,type: 'qq',mail: '',name: '狼鹰',goldnum: 600,lastlogintime: 1481514064593,accessToken: '',headpic: 'http://qzapp.qlogo.cn/qzapp/100358052/E8E9624A22874BDCE6E3B7E68D3DAD8F/100',sex: 1}
...
function showHistoryItem(data) {
  ...
  return ('<li class="item"><a href="' + href + '" class="thumbnail"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="' + src + '" alt="' + data[1] + '"></a><div class="info"><h3 class="title"><a href="">' + data[1] + '</a></h3><p class="time">' + getTimeSpan(data[4]) + '</p><p class="attr"><span class="attr-label">阅读至:</span> <a href="' + readedHref + '">' + data[3] + '</a></p><p class="attr"><span class="attr-label">下一话:</span> <a href="' + nextHref + '">' + data[7] + '</a></p><div class="opt-del" data-id="' + data[0] + '"><i class="ift-del"></i><span class="text">删除</span></div></div></li>');
}
