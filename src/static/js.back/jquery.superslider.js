...
(function($){
  $.fn.slide=function(options){
    ...
    return this.each(function() {
      ...
      var pageString = (opts.pageString=="false"||opts.pageString==false)?false:true;
      ...
      if( autoPage ){
        ...
        if( opts.autoPage==true || opts.autoPage=="true" ){ for( var i=0; i<navObjSize; i++ ){ str+="<li>"+(pageString?(i+1):'')+"</li>" } }
